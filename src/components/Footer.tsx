...
const Footer = () => {
  ...
  const freeTools = [
    ...
    {
      name: "Resume Skills Section Generator",
      icon: Settings,
    ...
    {
      name: "Job Interview Practice Tool",
      icon: MessageCircle,
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {freeTools.map((tool, index) => (
              <Button
                ...
                variant="ghost"
                className="h-auto p-4 text-left flex flex-col items-start space-y-2 hover:bg-gray-800 border border-gray-700 rounded-lg group transition-all duration-200"
              >
                <tool.icon className="h-5 w-5 text-orange-500 group-hover:text-orange-400" />
                <div>
                  <div className="font-medium text-sm text-white group-hover:text-orange-400">
                    {tool.name}
                  </div>
